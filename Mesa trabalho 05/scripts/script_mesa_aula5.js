...
function alteraTema() {
    ...
    if (toggleswitch.checked) { //Caso seja verdadeiro, ou seja, está selecionado
        ...
        /* Adicionando as classes (dark-mode) css nos elementos capturados. body e h1 são elementos
        que podem ser diretamente capturados pela sua TAG (como foi feito em cima), depois neles
         será adicionado as classes body-dark e h1-dark */
        body.classList.add('body-dark');
        h1.classList.add('h1-dark');


        // Para o restante dos elementos que contem as imagens dos felinos
        // junto com uma descrição iremos a utilizar um loop, tais elementos já foram capturados na primeira parte do 
        // exercicio
        ...
        itemsList.forEach(item => {
            item.classList.add('items-dark');
            item.classList.add('items-text-dark'); /*Essa parte pode ser eliminada*/
        });
