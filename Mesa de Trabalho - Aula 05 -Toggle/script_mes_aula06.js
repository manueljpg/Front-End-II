...
let card = document.getElementsByClassName('item');
let titulo= document.createElement('h2');
let descricao = document.createElement('p');
let img = document.createElement('img');


window.onload = function prencherElementos () {
listafelinos.forEach((e) => 
{
    let textoTitulo = document.createTextNode(e.titulo);
